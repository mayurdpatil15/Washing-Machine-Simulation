...
SOURCEFILES_QUOTED_IF_SPACED=main.c clcd.c isr.c digitalkeypad.c timer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/digitalkeypad.p1 ${OBJECTDIR}/timer.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/isr.p1.d ${OBJECTDIR}/digitalkeypad.p1.d ${OBJECTDIR}/timer.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/digitalkeypad.p1 ${OBJECTDIR}/timer.p1

# Source Files
SOURCEFILES=main.c clcd.c isr.c digitalkeypad.c timer.c
...
${OBJECTDIR}/digitalkeypad.p1: digitalkeypad.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/digitalkeypad.p1.d 
	@${RM} ${OBJECTDIR}/digitalkeypad.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/digitalkeypad.p1 digitalkeypad.c 
	@-${MV} ${OBJECTDIR}/digitalkeypad.d ${OBJECTDIR}/digitalkeypad.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/digitalkeypad.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
